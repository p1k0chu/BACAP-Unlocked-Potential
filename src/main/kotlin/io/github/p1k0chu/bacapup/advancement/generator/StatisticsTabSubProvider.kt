...
object StatisticsTabSubProvider : AdvancementSubProvider {
    ...
    override fun generate(provider: HolderLookup.Provider, consumer: AdvancementConsumer) {
        val emeraldPortfolio = advancement(consumer, TAB_NAME, EMERALD_PORTFOLIO) {
            ...
            addCriterion(
                "200", BacapupTriggers.TRADED_FOR_EMERALDS.createCriterion(
        ...
        val stockMarket = advancement(consumer, TAB_NAME, THE_STOCK_MARKET) {
            ...
            addCriterion(
                "576", BacapupTriggers.TRADED_FOR_EMERALDS.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
        ...
        val smallBusiness = advancement(consumer, TAB_NAME, SMALL_BUSINESS) {
            ...
            addCriterion(
                "1000", BacapupTriggers.TRADED_FOR_EMERALDS.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
        ...
        advancement(consumer, TAB_NAME, SMALL_INDIE_COMPANY) {
            ...
            addCriterion(
                "15552", BacapupTriggers.TRADED_FOR_EMERALDS.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
        ...
        val glgltu = advancement(consumer, TAB_NAME, GLGLTU) {
            ...
            addCriterion(
                "glgltu", BacapupTriggers.GLGLTU.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
                        Optional.of(
        ...
        val glgltuCult = advancement(consumer, TAB_NAME, GLGLTU_CULT) {
            ...
            addCriterion(
                "glgltu_cult", BacapupTriggers.GLGLTU.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
                        Optional.of(
        ...
        advancement(consumer, TAB_NAME, GLGLTU_3) {
            ...
            addCriterion(
                "glgltu_3", BacapupTriggers.GLGLTU.createCriterion(
                    SingleIntRangeTrigger.Instance(
                        Optional.empty(),
                        Optional.of(
