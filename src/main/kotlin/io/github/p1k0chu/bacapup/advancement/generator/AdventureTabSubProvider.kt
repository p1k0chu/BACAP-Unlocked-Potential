...
import io.github.p1k0chu.bacapup.advancement.triggers.*
...
object AdventureTabSubProvider : AdvancementSubProvider {
    ...
    override fun generate(provider: HolderLookup.Provider, consumer: AdvancementConsumer) {
        val catGift = advancement(consumer, TAB_NAME, CAT_GIFT) {
            ...
            addCriterion("gift", BacapupTriggers.CAT_GIFT_RECEIVED.createCriterion(SingleItemTrigger.Instance()))
        }
        ...
        val plethoraOfCats = advancement(consumer, TAB_NAME, PLETHORA_OF_CATS) {
            ...
            exp = 50
            addCriterion(
                "20", BacapupTriggers.PET_TAMED.createCriterion(
        ...
        advancement(consumer, TAB_NAME, ALL_CAT_GIFTS) {
            ...
            listOf(
                ...
                addCriterion(
                    it.builtInRegistryHolder().registeredName, BacapupTriggers.CAT_GIFT_RECEIVED.createCriterion(
                        SingleItemTrigger.Instance.items(provider, it)
                    )
                )
            }
        }
        ...
        advancement(consumer, TAB_NAME, LOCK_MAP) {
            ...
            addCriterion("lock", BacapupTriggers.MAP_LOCKED.createCriterion(EmptyTrigger.Instance()))
        }
        ...
        advancement(consumer, TAB_NAME, CAN_YOU_HEAR_IT_FROM_HERE) {
            ...
            exp = 50
            addCriterion(
                "50", BacapupTriggers.BELL_SHOT_FROM_DISTANCE.createCriterion(
        ...
        advancement(consumer, TAB_NAME, MASTER_ARCHEOLOGIST) {
            ...
            CollectItemsConstants.SUS_LOOT.forEach { item ->
                addCriterion(
                    item.builtInRegistryHolder().registeredName, BacapupTriggers.SUS_BLOCK_GOT_ITEM.createCriterion(
                        SingleItemTrigger.Instance.items(provider, item)
                    )
                )
            }
        }
        ...
        advancement(consumer, TAB_NAME, MAXIMUM_COVERAGE) {
            ...
            addCriterion(
                "max_coverage", BacapupTriggers.MAP_STATE.createCriterion(
                    MapTrigger.Instance(
                        Optional.empty(),
        ...
        advancement(consumer, TAB_NAME, PAINT_IT_RED) {
            ...
            addCriterion(
                "paint_it_red", BacapupTriggers.MAP_STATE.createCriterion(
                    MapTrigger.Instance(
                        Optional.empty(),
                        Optional.of(
                            MapStatePredicate(
        ...
        advancement(consumer, TAB_NAME, SECRET_SUPPLIES) {
            ...
            addCriterion(
                "milk_bucket", BacapupTriggers.WANDERING_TRADER_DROPPED_ITEM.createCriterion(
            ...
            addCriterion(
                "potion", BacapupTriggers.WANDERING_TRADER_DROPPED_ITEM.createCriterion(
                    EntityDroppedLootTrigger.Instance(
                        Optional.empty(),
                        Optional.of(
                            EntityPredicate.Builder.entity()
        ...
        advancement(consumer, TAB_NAME, DEHYDRATION) {
            ...
            addCriterion(
                "dehydration", BacapupTriggers.FURNACE_TOOK_WATER_BUCKET_FUEL.createCriterion(
                    EmptyTrigger.Instance()
                )
            )
        }
