...
object NetherTabSubProvider : AdvancementSubProvider {
    ...
    override fun generate(
        ...
        advancement(consumer, TAB_NAME, EXTREME_BREAK_RISK) {
            ...
            addCriterion(
                "netherite_block", BacapupTriggers.PLAYER_BREAK_NETHERITE_BLOCK_WITH_FIST.createCriterion(
        ...
        advancement(consumer, TAB_NAME, BEACON_ALL_ITEMS) {
            ...
            listOf(
                ...
                addCriterion(
                    item.builtInRegistryHolder().registeredName, BacapupTriggers.BEACON_CONSUMED_PAYMENT.createCriterion(
