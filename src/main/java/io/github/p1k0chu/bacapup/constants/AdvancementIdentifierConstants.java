...
public final class AdvancementIdentifierConstants {
    ...
    public static final Identifier THIS_IS_NOT_COOKIE_CLICKER = AdvancementUtils.id(FarmingTabGenerator.TAB_NAME, FarmingTabGenerator.THIS_IS_NOT_COOKIE_CLICKER);
